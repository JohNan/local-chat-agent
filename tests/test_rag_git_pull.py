...
def test_rag_git_pull_trigger():
    ...
    with patch("app.services.git_ops.perform_git_pull") as mock_git_pull, \
         patch("app.services.rag_manager.index_codebase_task") as mock_rag_task:
        ...
        with TestClient(app) as client:
            ...
            assert mock_rag_task.called, "RAG indexing task should be called after successful git pull"
...
def test_rag_git_pull_fail_no_trigger():
    ...
    with patch("app.services.git_ops.perform_git_pull") as mock_git_pull, \
        ...
        with TestClient(app) as client:
            ...
            assert not mock_rag_task.called, "RAG indexing task should NOT be called after failed git pull"
