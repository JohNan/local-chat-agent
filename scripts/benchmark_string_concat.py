"""
Benchmark script for string concatenation.
"""

import timeit


def old_way(parts_list):
    """
    Old way of concatenating strings using += in a loop.
    """
    content = ""
...
def new_way(parts_list):
    """
    New way of concatenating strings using ''.join().
    """
    return "".join(part["text"] for part in parts_list if "text" in part)
